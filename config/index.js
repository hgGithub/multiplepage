...
module.exports = {
  dev: {
    ...
    proxyTable: {
        '/wtb': {
          target: 'http://10.0.22.58:12580'
      }
    },

    // Various Dev Server settings
    host: 'localhost', // can be overwritten by process.env.HOST,//client debug 0.0.0.0
